...
def render_robots(base_url: str) -> str:
    return (
        ...
        # `/cabinet/` — прежние адреса редактора и кабинета; заглушки-редиректы
        # сняты 2026-09-01, сами адреса теперь 404, но запрет держим: они
        # разошлись по закладкам, а каталоги ещё висят на томе публикации.
        "Disallow: /work/\n"
        "Disallow: /cabinet/\n"
        "Disallow: /app/\n"
        "Disallow: /*?editor=\n"
