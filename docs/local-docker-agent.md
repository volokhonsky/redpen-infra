...
Рабочие копии обоих скриптов живут в `~/.claude-agent-docker/` — правя их, копируй
изменение в репозиторий, иначе версионная копия отстаёт (так и было до 2026-09-05).
