...
Раздел вынесен в **`docs/analytics-setup.md`** (2026-08-30): он единственный в
этом файле был живым, и это его и погубило — внутри документа с пометкой «не
обновлять» он успел разойтись с кодом. Остальной файл — история.
